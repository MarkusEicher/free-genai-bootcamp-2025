...
def test_service():
    ...
    class _TestService(BaseService[Vocabulary, VocabularyCreate, VocabularyUpdate]):
        model = Vocabulary
    return _TestService()

def test_get_nonexistent(db_session, test_service):
    """Test getting a non-existent record."""
    result = test_service.get(db_session, id=999999)
    assert result is None

def test_get_existing(db_session, test_vocabulary, test_service):
...
def test_get_multi_with_limit(db_session, test_vocabulary, test_service):
...
def test_get_multi_with_filters(db_session, test_vocabulary, test_service):
...
def test_create_success(db_session, test_language_pair, test_service):
...
def test_create_duplicate(db_session, test_vocabulary, test_service):
...
def test_update_success(db_session, test_vocabulary, test_service):
...
def test_update_with_dict(db_session, test_vocabulary, test_service):
...
def test_delete_success(db_session, test_vocabulary, test_service):
...
def test_get_multi_invalid_filter(db_session, test_service):
...
def test_update_with_none_values(db_session, test_vocabulary, test_service):
...
def test_create_with_relationship(db_session, test_language_pair, test_service):
...
def test_get_multi_ordering(db_session, test_vocabulary, test_service):
